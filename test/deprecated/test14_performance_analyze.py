...
conv1 = conv2d((1, 28, 28), output_channel=1, kernel_size=3)
pool1 = max_pool(input_dim=(1, 26, 26), kernel_sz=2)
activ1 = relu((1, 13, 13))
conv2 = conv2d((1, 13, 13), output_channel=1, kernel_size=3)
pool2 = max_pool(input_dim=(3, 11, 11), kernel_sz=3)
activ2 = relu((1, 4, 4))
linear_layer = linear(1 * 4 * 4, 10)
